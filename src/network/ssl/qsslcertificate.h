...
//    qint32 generateCertificate() const;
    ...
    void setSignatureAlgorithm(const QSslCertificate::SignatureAlgorithm
            signatureAlgorithm = SignatureAlgorithm::sha256WithRSAEncryption) const;
    ...
    // Certificate info
    QSslCertificate::SignatureAlgorithm signatureAlgorithm() const;
